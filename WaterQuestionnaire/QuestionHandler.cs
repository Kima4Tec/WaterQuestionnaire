...
namespace WaterQuestionnaire
{
    public class QuestionHandler
    {
        ...
        public void ShowQuestions(List<QuestionData> allQuestions)
        {
        ...
        public void CheckScore()
        {
            ...
            Skriv(4, 10, $"Antal rigtige svar: {AntalRigtige}\tAntal forkerte svar: {AntalForkerte}");
            Console.ReadLine();
        }
        ...
        public void Skriv(int x, int y, String tekst)
        {
